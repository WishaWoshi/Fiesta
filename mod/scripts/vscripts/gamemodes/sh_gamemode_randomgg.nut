...
void function CreateGamemodeRandomGG()
{
	...
	// car
	FiestaWeapon ggCar = { weapon = "mp_weapon_car", mods = [], ... }
	file.weapons.append( ggCar )

	// alternator
	FiestaWeapon ggAlternator = { weapon = "mp_weapon_alternator_smg", mods = [], ... }
	file.weapons.append( ggAlternator )

	// volt
	FiestaWeapon ggVolt = { weapon = "mp_weapon_hemlok_smg", mods = [], ... }
	file.weapons.append( ggVolt )

	// r97
	FiestaWeapon ggR97 = { weapon = "mp_weapon_r97", mods = [], ... }
	...
	// hemlok
	FiestaWeapon ggHemlok = { weapon = "mp_weapon_hemlok", mods = [], ... }
	file.weapons.append( ggHemlok )

	// flatline
	FiestaWeapon ggFlatline = { weapon = "mp_weapon_vinson", mods = [], ... }
	file.weapons.append( ggFlatline )

	// r201
	FiestaWeapon ggR101 = { weapon = "mp_weapon_rspn101", mods = [], ... }
	file.weapons.append( ggR101 )

	// r101
	FiestaWeapon ggR101og = { weapon = "mp_weapon_rspn101_og", mods = [], ... }
	file.weapons.append( ggR101og )

	// g2
	FiestaWeapon ggG2A5 = { weapon = "mp_weapon_g2", mods = [], ... }
	file.weapons.append( ggG2A5 )

	// lmgs

	// devotion
	FiestaWeapon ggDevotion = { weapon = "mp_weapon_esaw", mods = [], ... }
	file.weapons.append( ggDevotion )

	// l-star
	FiestaWeapon ggLstar = { weapon = "mp_weapon_lstar", mods = [], ... }
	file.weapons.append( ggLstar )

	// spitfire
	FiestaWeapon ggSpitfire = { weapon = "mp_weapon_lmg", mods = [], ... }
	file.weapons.append( ggSpitfire )

	// shotguns

	// eva-8
	FiestaWeapon ggEva = { weapon = "mp_weapon_shotgun", mods = [], ... }
	file.weapons.append( ggEva )

	// mastiff
	FiestaWeapon ggMastiff = { weapon = "mp_weapon_mastiff", mods = [], ... }
	...
	// softball
	FiestaWeapon ggSoftball = { weapon = "mp_weapon_softball", mods = [], ... }
	file.weapons.append( ggSoftball )

	// epg
	FiestaWeapon ggEpg = { weapon = "mp_weapon_epg", mods = [], ... }
	file.weapons.append( ggEpg )

	// smr
	FiestaWeapon ggSmr = { weapon = "mp_weapon_smr", mods = [], ... }
	file.weapons.append( ggSmr )

	// call of duty: bad
	FiestaWeapon ggCold = { weapon = "mp_weapon_pulse_lmg", mods = [], ... }
	file.weapons.append( ggCold )

	// primary pistols

	// mozambique
	FiestaWeapon ggMozam = { weapon = "mp_weapon_shotgun_pistol", mods = [], ... }
	file.weapons.append( ggMozam )

	// wingman elite
	FiestaWeapon ggWme = { weapon = "mp_weapon_wingman_n", mods = [], ... }
	...
	// double take
	FiestaWeapon ggTaketake = { weapon = "mp_weapon_doubletake", mods = [], ... }
	file.weapons.append( ggTaketake )

	// kraber
	FiestaWeapon ggKraber = { weapon = "mp_weapon_sniper", mods = [], ... }
	...
	// re-45
	FiestaWeapon ggRe45 = { weapon = "mp_weapon_autopistol", mods = [], ... }
	file.weapons.append( ggRe45 )

	// p2016
	FiestaWeapon ggP2016 = { weapon = "mp_weapon_semipistol", mods = [], ... }
	file.weapons.append( ggP2016 )

	// wingman
	FiestaWeapon ggWingman = { weapon = "mp_weapon_wingman", mods = [], ... }
	file.weapons.append( ggWingman )


	// final/special weapons
	// charge rifle
	FiestaWeapon ggChargeRifle = { weapon = "mp_weapon_defender", mods = [], ... }
	...
	// frag grenade
	FiestaWeapon ggFrag = { weapon = "mp_weapon_frag_grenade", mods = [], ...}
	file.ordnance.append( ggFrag )

	// arc grenade
	FiestaWeapon ggArc = { weapon = "mp_weapon_grenade_emp", mods = [], ... }
	file.ordnance.append( ggArc )

	// firestar
	FiestaWeapon ggFire = { weapon = "mp_weapon_thermite_grenade", mods = [], ... }
	file.ordnance.append( ggFire )

	// gravstar
	FiestaWeapon ggGrav = { weapon = "mp_weapon_grenade_gravity", mods = [], ... }
	file.ordnance.append( ggGrav )

	// esmoke
	FiestaWeapon ggSmoke = { weapon = "mp_weapon_grenade_electric_smoke", mods = [], ... }
	file.ordnance.append( ggSmoke )

	// satchel
	FiestaWeapon ggSatchel = { weapon = "mp_weapon_satchel", mods = [], ... }
	...
	// cloak
	FiestaWeapon ggCloak = { weapon = "mp_ability_cloak", mods = [], ... }
	file.tacticals.append( ggCloak )

	// sonar
	FiestaWeapon ggSonar = { weapon = "mp_weapon_grenade_sonar", mods = [], ... }
	file.tacticals.append( ggSonar )

	// grapple
	FiestaWeapon ggGrapple = { weapon = "mp_ability_grapple", mods = [], ... }
	file.tacticals.append( ggGrapple )

	// stim
	FiestaWeapon ggStim = { weapon = "mp_ability_heal", mods = [], ... }
	file.tacticals.append( ggStim )

	// awall
	FiestaWeapon ggCunt = { weapon = "mp_weapon_deployable_cover", mods = [], ... }
	file.tacticals.append( ggCunt )

	// phase shift
	FiestaWeapon ggPhase = { weapon = "mp_ability_shifter", mods = [], ... }
	file.tacticals.append( ggPhase )

	// holo
	FiestaWeapon ggHolo = { weapon = "mp_ability_holopilot", mods = [], ... }
